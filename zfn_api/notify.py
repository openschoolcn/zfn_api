...
push_config = {
    ...
    'SMTP_EMAIL': '1954371622@qq.com',                   # SMTP 收发件邮箱，通知将会由自己发给自己
    'SMTP_PASSWORD': 'peceafkspelfgihg',                # SMTP 登录密码，也可能为特殊口令，视具体邮件服务商说明而定
    'SMTP_NAME': '自动推送',                    # SMTP 收发件人姓名，可随意填写
...
def smtp(title: str, content: str, toEmail="") -> None:
    """
    使用 SMTP 邮件 推送消息。
    """
    if (
